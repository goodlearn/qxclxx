...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sys/leftMotorWheelInfo/">主发电机主要参数列表</a></li>
		<shiro:hasPermission name="sys:leftMotorWheelInfo:edit"><li><a href="${ctx}/sys/leftMotorWheelInfo/form">主发电机主要参数添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="leftMotorWheelInfo">
			<tr>
				...
				<shiro:hasPermission name="sys:leftMotorWheelInfo:edit"><td>
					...
					<a href="${ctx}/sys/leftMotorWheelInfo/delete?id=${leftMotorWheelInfo.id}" onclick="return confirmx('确认要删除该主发电机主要参数吗？', this.href)">删除</a>
