...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/oneShoeInfo/">1#轮胎主要参数列表</a></li>
		<li class="active"><a href="${ctx}/sys/oneShoeInfo/form?id=${oneShoeInfo.id}">1#轮胎主要参数<shiro:hasPermission name="sys:oneShoeInfo:edit">${not empty oneShoeInfo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:oneShoeInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="oneShoeInfo" action="${ctx}/sys/oneShoeInfo/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:oneShoeInfo:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
