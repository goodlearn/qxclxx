...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/engineInfo/">发动机主要参数列表</a></li>
		<li class="active"><a href="${ctx}/sys/engineInfo/form?id=${engineInfo.id}">发动机主要参数<shiro:hasPermission name="sys:engineInfo:edit">${not empty engineInfo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:engineInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="engineInfo" action="${ctx}/sys/engineInfo/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:engineInfo:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
