...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/boxBucketInfo/">箱斗主要参数列表</a></li>
		<li class="active"><a href="${ctx}/sys/boxBucketInfo/form?id=${boxBucketInfo.id}">箱斗主要参数<shiro:hasPermission name="sys:boxBucketInfo:edit">${not empty boxBucketInfo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:boxBucketInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="boxBucketInfo" action="${ctx}/sys/boxBucketInfo/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:boxBucketInfo:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
