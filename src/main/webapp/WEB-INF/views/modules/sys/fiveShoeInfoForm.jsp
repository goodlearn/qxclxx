...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/fiveShoeInfo/">5#轮胎主要参数列表</a></li>
		<li class="active"><a href="${ctx}/sys/fiveShoeInfo/form?id=${fiveShoeInfo.id}">5#轮胎主要参数<shiro:hasPermission name="sys:fiveShoeInfo:edit">${not empty fiveShoeInfo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:fiveShoeInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="fiveShoeInfo" action="${ctx}/sys/fiveShoeInfo/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:fiveShoeInfo:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
