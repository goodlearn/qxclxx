...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/sixShoeInfo/">6#轮胎主要参数列表</a></li>
		<li class="active"><a href="${ctx}/sys/sixShoeInfo/form?id=${sixShoeInfo.id}">6#轮胎主要参数<shiro:hasPermission name="sys:sixShoeInfo:edit">${not empty sixShoeInfo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:sixShoeInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="sixShoeInfo" action="${ctx}/sys/sixShoeInfo/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:sixShoeInfo:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
