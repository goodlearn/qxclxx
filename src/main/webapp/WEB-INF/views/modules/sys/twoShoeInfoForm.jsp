...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/twoShoeInfo/">2#轮胎主要参数列表</a></li>
		<li class="active"><a href="${ctx}/sys/twoShoeInfo/form?id=${twoShoeInfo.id}">2#轮胎主要参数<shiro:hasPermission name="sys:twoShoeInfo:edit">${not empty twoShoeInfo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:twoShoeInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="twoShoeInfo" action="${ctx}/sys/twoShoeInfo/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:twoShoeInfo:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
