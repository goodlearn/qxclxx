...
<head>
	...
	<link href="${ctx}/wx/wxcss/normalize.css" type="text/css" rel="stylesheet" />
	<link href="${ctx}/wx/wxcss/common.css" type="text/css" rel="stylesheet" />
	<script src="${ctx}/wx/wxjs/jquery.min.js" type="text/javascript"></script>
	<script src="${ctx}/wx/wxjs/qrcode.min.js" type="text/javascript"></script>
	<script src="${ctx}/wx/wxjs/common.js" type="text/javascript"></script>
	<style type="text/css">
		body{
			background: #f4f4f4;
		}
