...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/fourShoeInfo/">4#轮胎主要参数列表</a></li>
		<li class="active"><a href="${ctx}/sys/fourShoeInfo/form?id=${fourShoeInfo.id}">4#轮胎主要参数<shiro:hasPermission name="sys:fourShoeInfo:edit">${not empty fourShoeInfo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:fourShoeInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="fourShoeInfo" action="${ctx}/sys/fourShoeInfo/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:fourShoeInfo:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
