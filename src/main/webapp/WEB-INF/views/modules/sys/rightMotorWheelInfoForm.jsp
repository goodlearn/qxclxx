...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/rightMotorWheelInfo/">右侧电动轮主要参数列表</a></li>
		<li class="active"><a href="${ctx}/sys/rightMotorWheelInfo/form?id=${rightMotorWheelInfo.id}">右侧电动轮主要参数<shiro:hasPermission name="sys:rightMotorWheelInfo:edit">${not empty rightMotorWheelInfo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:rightMotorWheelInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="rightMotorWheelInfo" action="${ctx}/sys/rightMotorWheelInfo/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:rightMotorWheelInfo:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
